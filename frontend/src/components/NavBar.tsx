	...
	return (
		...
		>
			<nav className='flex flex-col gap-6 text-lg font-medium lg:gap-6'>
				...
				>
					<Logo className='w-12 h-6 mr-2' />
					<span className="hidden font-bold md:inline-block mt-1">Eldora AI</span>
                    <Badge variant="secondary" className='ml-1 mt-1'>Beta</Badge>
				</Button>
			</nav>
			...
			<div className='flex w-full items-center justify-end'>
				...
				>
					<a
						...
						rel='noreferrer'
						target='_blank'
						href='https://github.com/karthikmudunuri/eldoraai'
					>
						<svg
							className='h-4 w-4'
							width='24'
